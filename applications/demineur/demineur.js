...
// PARTIE 12 ==> ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- VICTOIRE ==>
    ...
    function Victoire(){
        ...
        if(!document.getElementById(index).classList.contains("case") && document.getElementById(index).innerHTML != '<img src="../../imagesWLM/win.png" alt="Drapeau" style="height:20px;width:20px;">'){
            PlacerIndice(index);
        }
