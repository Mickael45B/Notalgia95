            ...
            const fermer = document.getElementById("P0-1-2_fermerModal1");
            const modal = document.getElementById("P0_modalPourApplications_1");
            ...
            var enteteModal = document.getElementsByClassName("P0-1-1_enTeteFenetre")[0]; // Prendre le premier élément
            ...
            Array.from(buttons).forEach(function(button) {
                button.addEventListener("click", function() {
                    ...
                    let fichier = appFiles[fileToLoad]; // Sélectionne le fichier correspondant
        
                    // Charger le fichier dans l'iframe
                    document.getElementById("P0-2_contenuModal1").src = fichier;
                    ...
                    var iframeLoadTimeout = setTimeout(function() {
                        document.getElementById("P0-2_contenuModal1").src = "ERREUR404.html";  // Charger la page d'erreur si timeout
                    }, 5000); // Délai de 5 secondes
        
                    // Si le fichier se charge correctement, annuler le timeout
                    document.getElementById("P0-2_contenuModal1").onload = function() {
